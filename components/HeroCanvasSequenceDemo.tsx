...
const FRAME_PATH = (index: number) =>
  `/frames-demo/frame_${String(index + 1).padStart(4, "0")}.jpg`;
...
export default function HeroCanvasSequenceDemo() {
  ...
  const drawFrame = (index: number) => {
    ...
    // Cover-fit: fills the box on the constraining axis and crops the other.
    ...
    // Anchor to the top so any crop comes from the bottom, keeping the
    // top of the frame (sky/skyline) fully visible.
    const dy = 0;
